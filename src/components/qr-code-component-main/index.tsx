...
export default component$(() => {
  return (
    <main class="w-screen h-screen flex justify-center items-center bg-[hsl(212,45%,89%)] text-center">
      <section class="xs:w-[330px] w-[85%] flex flex-col bg-white p-4 rounded-3xl">
        ...
        <h1 class="my-6 mx-2 xs:text-2xl text-xl text-[hsl(218,44%,22%)] font-bold font-outfit">
